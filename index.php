<?php include("header.php"); ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="subscribe-text-link">
                                    <div class="subscribe-link">
                                        ...
                                        <p class="discount-text">SUMMER SALE! 10% off student discount</p>
                                    </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="product-carousel">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="single-product-item">
                                        ...
                                        <h2 class="single-product-name"><a href="#">Quisque in arcu</a></h2>
                                        <div class="price-box">
                                            <p class="old-price">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="single-product-item">
                                        ...
                                        <h2 class="single-product-name"><a href="#">Proin lectus ipsum</a></h2>
                                        <div class="price-box">
                                            <p class="old-price">
            ...
            <div class="blog-area">
                <div class="container">
                    <div class="section-padding">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section-title"><h2>From the blog</h2></div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <!--End of Brand Area-->
            <!--Service Area Start-->
            <div class="service-area-home-two">
                <div class="container">
